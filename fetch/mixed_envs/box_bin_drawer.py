...
class BoxBinDrawerEnv(fetch_env.FetchEnv, utils.EzPickle):
    def __init__(self, action, reward_type='sparse'):
        ...
        self.initial_qpos = {
            ...
            'drawer:slide': 0.,
            'box:joint': [1.15, 1.1, 0.4, 1, 0., 0., 0.],
            'lid:joint': [1.15, 1.1, 1, 1, 0., 0., 0.],
        }
        fetch_env.FetchEnv.__init__(
            self, "box_bin_drawer.xml",
            ...
            obj_keys=("bin", "cabinet", "drawer", "box", "lid", "object0"),
            obs_keys=("bin", "cabinet", "box", "lid", "object0"),
            goal_key="object0",
        )
